                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center p-3 bg-light rounded">
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-bold text-danger fs-5">{{ formatMoney(item.don_gia_kham) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="fw-bold fs-5">
                                                            {{ formatMoney(chi_tiet_lich_hen.don_gia_kham) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="mb-3">
                                        <div class="border rounded p-3 bg-white d-inline-block">
                                            <img :src="'https://img.vietqr.io/image/mbbank-0702632725-compact2.jpg?amount=' + chi_tiet_lich_hen.tong_tien + '&addInfo=' + chi_tiet_lich_hen.id"
                                    ...
                                    <div class="alert alert-info">
                                        <div class="text-start">
                                            ...
                                            <div class="mb-2">
                                                <strong>Số tài khoản:</strong> 0702632725
                                            </div>
                                            <div class="mb-2">
                                                <strong>Chủ tài khoản:</strong> Nguyen trong Duong
                                            </div>
                                            <div class="mb-2">
                                            ...
                                            <div>
                                                <strong>Nội dung:</strong> NTD205 {{ chi_tiet_lich_hen.id }}
                                            </div>
                                        </div>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        ThanhToanLichHen() {
            baseRequestBenhNhan.post('benh-nhan/thanh-toan-lich-hen', {
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token_benh_nhan"),
                },
            })
        ...
        HuyLichHen() {
            baseRequestBenhNhan.post('benh-nhan/huy-lich-hen', {
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token_benh_nhan"),
                },
            })
        ...
        layGiaoDich(){
         var payload = {
                "USERNAME": "NGUYENTRONGDUONG",
                "PASSWORD": "0702632725",
                "DAY_BEGIN": "22/09/2025",
                "DAY_END": "22/09/2025",
                "NUMBER_MB": "0702632725",
            };
            axios.post('https://api-mb.midstack.io.vn/api/transactions', payload)
            .then((res) => {
