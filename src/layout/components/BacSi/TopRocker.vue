            ...
            <nav class="navbar navbar-expand">
                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <img :src="userProfile.hinh_anh || '../../../assets/images/avatars/avatar-1.png'" class="user-img" alt="user avatar">
                        <div class="user-info ps-3">
                            <p class="user-name mb-0">{{ userProfile.ho_ten || 'Bác sĩ' }}</p>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="javascript:;" @click="logout()"><i
                                    class='bx bx-log-out'></i><span>Đăng xuất</span></a>
                        </li>
                        <li>
...
export default {
    ...
    methods: {
        ...
        logout() {
            baseRequestBacsi.post('bac-si/logout', {}, {
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("token_bac_si"),
                },
            })
                .then(res => {
                    if (res.data.status) {
                        localStorage.removeItem('token_bac_si');
                        localStorage.removeItem('ho_ten_bac_si');
